...
MCP stdio server wrapping `@ai-native-solutions/fallpair-sdk`.

## Install
```bash
claude mcp add fallpair -- npx -y @ai-native-solutions/fallpair-mcp
```
...
- **Discoverable** — indexed on the FallMarket catalog at [sjgant80-hub.github.io/fallmarket/listing.html?id=fallpair-mcp](https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallpair-mcp)
...
- **Companion SDK** (`npm install @ai-native-solutions/fallpair-mcp-sdk`) — programmatic JavaScript API for direct integration.
- **Companion MCP server** (`claude mcp add fallpair-mcp -- npx -y @ai-native-solutions/fallpair-mcp-mcp`) — Model Context Protocol server that any Claude/Cursor/Codex client can invoke as a tool.
- **Companion HTTP API** (`docker run --rm ghcr.io/sjgant80-hub/fallpair-mcp-api`) — containerized REST endpoint for language-agnostic access.
...
- **Registry entry**: https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallpair-mcp
- **Live URL**: https://sjgant80-hub.github.io/fallpair-mcp/
- **Source**: https://github.com/sjgant80-hub/fallpair-mcp
